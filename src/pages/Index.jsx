                ...
                <section className="shadow-md rounded-lg p-6 bg-[#15181D]">
                    ...
                    <ol className="list-decimal pl-6 text-white mb-4">
                        ...
                        <ol className="list-disc pl-6 text-white">
                            ...
                            <li>After pushing, open your repository on GitHub, go to <b>Settings &gt; Pages</b>, then select the <code className="bg-[#1C232B] px-1 rounded">gh-pages</code> branch as the source and click Save.</li>
                        </ol>
                    </ol>
                </section>
            </main>
